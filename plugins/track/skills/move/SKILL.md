...
2. Locate task file by ID under `.track/tasks/`.
...
5. Move file to `.track/tasks/{target_status}/`.
...
Report: old path → new path, changed fields, validation status, board refresh status.
