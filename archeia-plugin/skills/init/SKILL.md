...
version: 0.1.0
description: |
  This skill should be used when the user asks to "run archeia", "generate architecture
  docs", "create .archeia/", "initialize archeia", "write AGENTS.md or CLAUDE.md",
  "update architecture guidance", "document this repo's architecture", or wants to
  generate or maintain architecture knowledge for a repository.
allowed-tools:
  - Bash
  - Read
  - Glob
...
2. Read existing root docs, package/service boundaries, CI, and test setup.
